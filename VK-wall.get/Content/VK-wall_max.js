...
// кнопки навигации
	...
	var num_sheets=Math.ceil(num_post/15);
...
function but(n) {//обработчик нажатия кнопок
	...
	var offset = (n-1)*15;
	var count = offset + 15;
	var url = "https://api.vk.com/method/wall.get?owner_id=-803&offset=" + offset + "&count=" + count + "&filter=all&v=5.40&callback=count";
